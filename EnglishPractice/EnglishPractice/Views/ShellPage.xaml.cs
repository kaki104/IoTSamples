...
using EnglishPractice.Services;
...
namespace EnglishPractice.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private async void InitializeCases()
        {
            ...
            if (await storageFolder.FileExistsAsync("case1.csv") == false) return;
        ...
        /// 케이스 목록
        /// </summary>
        public IList<Case> CaseList { get; set; } = new List<Case>();
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<PredefindedPage>("Shell_Predefinded".GetLocalized(), Symbol.Document));
        }
